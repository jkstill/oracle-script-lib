...
<a href='https://github.com/jkstill/oracle-script-lib/blob/master/sql/cf-waits.sql'>cf-waits.sql</a> - show control file waits
<a href='https://github.com/jkstill/oracle-script-lib/blob/master/sql/concurrency-waits-sqlid.sql'>concurrency-waits-sqlid.sql</a> - show concurrency waits from standard v$ views
...
<a href='https://github.com/jkstill/oracle-script-lib/blob/master/sql/cpu-stalled-ratio.sql'>cpu-stalled-ratio.sql</a> - ratio of ON CPU/resmgr
...
<a href='https://github.com/jkstill/oracle-script-lib/blob/master/sql/awr-itl-wait-details.sql'>awr-itl-wait-details.sql</a> - ITL waits with details
...
<a href='https://github.com/jkstill/oracle-script-lib/blob/master/sql/concurrency-waits-sqlid.sql'>concurrency-waits-sqlid.sql</a> - show concurrency waits per sqlid from ASH
...
<pre>
<a href='https://github.com/jkstill/oracle-script-lib/blob/master/sql/disable-autotasks-resource-mgr.sql'>disable-autotasks-resource-mgr.sql</a> - calls scripts to disable resource manager to the extent possible
...
<a href='https://github.com/jkstill/oracle-script-lib/blob/master/sql/privileged-accounts.sql'>privileged-accounts.sql</a> - report on privileged user accounts (have ANY privs)
...
<a href='https://github.com/jkstill/oracle-script-lib/blob/master/sql/redo-per-hour.sql'>redo-per-hour.sql</a> - report on redo per hour
...
<a href='https://github.com/jkstill/oracle-script-lib/blob/master/sql/sess-event-summary.sql'>sess-event-summary.sql</a> - summary report of gv$session_event
...
<a href='https://github.com/jkstill/oracle-script-lib/blob/master/sql/tab-info.sql'>tab-info.sql</a> - some info on tables
...
<a href='https://github.com/jkstill/oracle-script-lib/blob/master/sql/uptime.sql'>uptime.sql</a> - show db uptime
...
<a href='https://github.com/jkstill/oracle-script-lib/blob/master/sql/user-modifiable-all-parms.sql'>user-modifiable-all-parms.sql</a> - show all parms modifiable by user sessions - requires sysdba
<a href='https://github.com/jkstill/oracle-script-lib/blob/master/sql/user-modifiable-parms.sql'>user-modifiable-parms.sql</a> - show user modifiable parameters
