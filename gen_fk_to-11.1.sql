...
fk as (
	...
	group by  cn.owner, cn.table_name, cn.constraint_name,column_list,delete_rule, deferrable, r_owner, r_constraint_name
...
refs as (
	select
		...
		, rcols.column_list
	from dba_constraints cn
	join rcols on rcols.owner = cn.owner
		and rcols.table_name = cn.table_name
		and rcols.constraint_name = cn.constraint_name
	group by  cn.owner, cn.table_name, cn.constraint_name, rcols.column_list
	order by cn.constraint_name
)
select
